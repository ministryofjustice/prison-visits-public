  ...
  describe '#send_email' do
    ...
    let(:client_params) do
      {
        ...
        personalisation: {
          ...
          where_to_check_status_html: pvbcommon_link_directory.visit_status(visit, locale: I18n.locale),
          ...
          feedback_url: pvbcommon_link_directory.feedback_submission(locale: I18n.locale),
          booked_subject_date: "",
          prisoner_full_name: visit.prisoner_full_name,
          prison_website: pvbcommon_link_directory.prison_finder(visit.prison),
          ...
          cancel_url: pvbcommon_link_directory.visit_status(visit, locale: I18n.locale),
    ...
    context 'when the !rejection.nil?' do
      ...
      context 'when rejection.email_formatted_reasons.size > 1' do
        let(:visitor) { create(:staff_visitor) }
        let(:visit) {
          create(:rejected_visit,
                 rejection_attributes: { reasons: [Rejection::SLOT_UNAVAILABLE, Rejection::NOT_ON_THE_LIST] },
                 visitors: [visitor])
        }
