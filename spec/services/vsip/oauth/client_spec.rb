...
RSpec.describe Vsip::Oauth::Client do
  describe '#post' do
    let(:auth_header) do
    ...
    describe 'with a valid request' do
      ...
      before do
        described_class.vsip_oauth_client_id = client_id
        described_class.vsip_oauth_client_secret = client_secret
      end

      after do
        described_class.vsip_oauth_client_id = Rails.configuration.nomis_oauth_host
        described_class.vsip_oauth_client_secret = Rails.configuration.vsip_oauth_client_secret
      end
