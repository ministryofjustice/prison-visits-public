...
RSpec.feature 'Booking a visit direct to nomis and to staff model', js: true do
  ...
  before do
    ...
    stub_request(:get, /.*available_dates.*/).to_return(body: { dates: %w[2017-03-14 2017-03-15 2017-03-16 2017-03-18 2017-03-18] }.to_json)

    # Notifier email

    allow_any_instance_of(Notifications::Client).to receive(:send_email).and_return(true)
  end
  ...
  #   cassette_name: :direct_request_a_visit_happy_path,
