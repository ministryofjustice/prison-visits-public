...
RSpec.describe StaffResponse, type: :model do
  ...
  describe 'validating a staff response' do
    ...
    context 'when not processable' do
      ...
      before do expect(subject).not_to be_valid end
    ...
    context 'when the lead visitor is not on the list' do
      ...
      let(:other_visitor) { build(:staff_visitor, visit:) }
    ...
    #     let!(:unlisted_visitor) { create(:staff_visitor, visit:) }
    #
    #     before do
    ...
    #     let!(:unlisted_visitor) { create(:staff_visitor) }
    #     let(:slot_granted)      { '' }
    #
    #     before do
  ...
  describe '#check_principal_visitor' do
    it 'principal visitor for banned visitor' do
      subject.send('principal_visitor').banned = true
      expect(subject).to be_valid
    end
  end
end
