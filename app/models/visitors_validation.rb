class VisitorsValidation
  ...
  def lead_visitor_age
    if age_calculator.age(lead_date_of_birth) < Staff::Prison::LEAD_VISITOR_MIN_AGE
      errors.add(:general, 'lead_visitor_age')
    end
  end

  def number_of_visitors
    if dates_of_birth.size > Staff::Prison::MAX_VISITORS
  ...
  def number_of_adults
    ...
    if adults.size > Staff::Prison::MAX_ADULTS
