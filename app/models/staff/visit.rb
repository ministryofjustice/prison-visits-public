class Staff::Visit < Staff::ApplicationRecord
  include PrincipalVisitor

  belongs_to :prison, class_name: 'Staff::Prison'
  belongs_to :prisoner, class_name: 'Staff::Prisoner'
  has_many :visitors, class_name: 'Staff::Visitor', dependent: :destroy

  has_many :visit_state_changes, dependent: :destroy
  has_many :messages, dependent: :destroy
  has_one :rejection, dependent: :destroy, inverse_of: :visit

  has_one :cancellation, class_name: 'Staff::Cancellation'
