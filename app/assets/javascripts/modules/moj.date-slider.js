  ...
  DateSlider.prototype = {
    ...
    buildDays: function(from, to, dayLabel) {
      ...
      while (curDate <= to) {
        ...
        out+= template({
          dayLabel: dayLabel,
          klass: moj.Helpers.dateBookable(curIso, this.slotPicker.bookableDates) ? '' : moj.Helpers.dateBookable(curIso, this.slotPicker.prisonerUnavailableDates) ? 'prisoner-unavailable' : 'unavailable',
          isoDate: curIso,
