module Vsip
  class Api
    ...
    def visit_sessions(nomis_id, prisoner_number)
      response = @pool.with { |client|
        client.get('visit-sessions/available', prisonId: nomis_id, prisonerId: prisoner_number.to_s.upcase, pvbAdvanceFromDateByDays: 1, toDateOverride: 28, userType: 'PUBLIC')
      }
      slots = {}
