...
module Vsip
  ...
  class Client
    ...
    # connection object to the Vsip API for each Thread. This is to make an
    ...
    # be up to 16 live connections to the Vsip API.
    #
  ...
  private
    ...
    def auth_header
      token = Vsip::Oauth::TokenService.valid_token
