...
class GovNotifyEmailer
  ...
  def send_email(visit, template_id, rejection = nil, message = nil, cancellation = nil)
    ...
    client.send_email(
      ...
      personalisation: {
        ...
        prison_website: pvbcommon_link_directory.prison_finder(Estate.find(visit.prison.estate_id)),
  ...
  def override_cancel_link(visit)
    ...
    if @override_cancel_link
      ...
      url = pvbcommon_link_directory.visit_status(visit, locale: I18n.locale)
    end
    url
  end
